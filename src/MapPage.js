      ...
      <div style={{ flex: 1, position: "relative" }}>
        ...
        {isMobile && (
          <>
            ...
            {showRanking && geoData && (
              <div style={{ position: "absolute", top: 60, left: 16, right: 16, width: "auto", background: "#1E293B", border: "1px solid #334155", borderRadius: 12, padding: 16, zIndex: 20, maxHeight: "50vh", overflowY: "auto", boxSizing: "border-box" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                  <p style={{ color: "#F1F5F9", fontSize: 13, fontWeight: 700, margin: 0 }}>{activeColumn.label} 상위 20</p>
